...
class __TwigTemplate_337c45e2bd513a0f0b36f4cf24558e35 extends Template
{
    private $source;
    private $macros = [];
...
<ul>
    <li><a href=\"{{ path('read_many') }}\" class=\"button\">Books</a></li>
    <li><a href=\"{{ path('create') }}\" class=\"button\">Add book</a></li>
</ul>
{% endblock %}", "library/index.html.twig", "/home/albinr/dbwebb-kurser/mvc/me/report/templates/library/index.html.twig");
    }
}
