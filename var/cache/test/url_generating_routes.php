...
return [
    ...
    'blackjack_doc' => [[], ['_controller' => 'App\\Controller\\BlackJackController::doc'], [], [['text', '/proj/blackjack/doc']], [], [], []],
    'api_blackjack_setup' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameSetup'], [], [['text', '/api/blackjack/setup']], [], [], []],
    'api_blackjack_status' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameStatus'], [], [['text', '/proj/api/blackjack']], [], [], []],
    'api_blackjack_hit' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameHit'], [], [['text', '/proj/api/blackjack/hit']], [], [], []],
    'api_blackjack_stand' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameStand'], [], [['text', '/proj/api/blackjack/stand']], [], [], []],
    'api_blackjack_deck' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameDeck'], [], [['text', '/proj/api/blackjack/deck']], [], [], []],
    ...
    'proj_api' => [[], ['_controller' => 'App\\Controller\\ProjController::apiLibrary'], [], [['text', '/proj/api']], [], [], []],
    ...
    'App\Controller\BlackJackController::doc' => [[], ['_controller' => 'App\\Controller\\BlackJackController::doc'], [], [['text', '/proj/blackjack/doc']], [], [], []],
    'App\Controller\BlackJackController::apiGameSetup' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameSetup'], [], [['text', '/api/blackjack/setup']], [], [], []],
    'App\Controller\BlackJackController::apiGameStatus' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameStatus'], [], [['text', '/proj/api/blackjack']], [], [], []],
    'App\Controller\BlackJackController::apiGameHit' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameHit'], [], [['text', '/proj/api/blackjack/hit']], [], [], []],
    'App\Controller\BlackJackController::apiGameStand' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameStand'], [], [['text', '/proj/api/blackjack/stand']], [], [], []],
    'App\Controller\BlackJackController::apiGameDeck' => [[], ['_controller' => 'App\\Controller\\BlackJackController::apiGameDeck'], [], [['text', '/proj/api/blackjack/deck']], [], [], []],
    ...
    'App\Controller\ProjController::apiLibrary' => [[], ['_controller' => 'App\\Controller\\ProjController::apiLibrary'], [], [['text', '/proj/api']], [], [], []],
